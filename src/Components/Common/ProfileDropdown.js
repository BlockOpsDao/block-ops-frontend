                ...
                <DropdownToggle tag="button" type="button" className="btn">
                    <span className="d-flex align-items-center">
                        ...
                        <span className="text-start ms-xl-2">
                            <span className="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{ens ?? shortenAddress(account)}</span>
                            <span className="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Contributor</span>
                        </span>
                    </span>
                </DropdownToggle>
                <DropdownMenu className="dropdown-menu-end">

                    <h6 className="dropdown-header">Welcome {ens ?? shortenAddress(account)}!</h6>
                    ...
                    <DropdownItem href="/landing"><Web3Wallet /></DropdownItem>
                </DropdownMenu>
            </Dropdown>
        </React.Fragment>
    );
